...
public class PlaylistResourceIT {
    ...
    private static final Integer DEFAULT_LIST_ID = 1;
    private static final Integer UPDATED_LIST_ID = 2;
    private static final Integer SMALLER_LIST_ID = 1 - 1;
    ...
    public void createPlaylist() throws Exception {
        ...
        assertThat(testPlaylist.getListId()).isEqualTo(DEFAULT_LIST_ID);
    ...
    @Test
    @Transactional
    public void checkListIdIsRequired() throws Exception {
    ...
    public void getAllPlaylists() throws Exception {
        ...
        restPlaylistMockMvc.perform(get("/api/playlists?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].listId").value(hasItem(DEFAULT_LIST_ID)))
    ...
    public void getPlaylist() throws Exception {
        ...
        restPlaylistMockMvc.perform(get("/api/playlists/{id}", playlist.getId()))
            ...
            .andExpect(jsonPath("$.listId").value(DEFAULT_LIST_ID))
    ...
    public void updatePlaylist() throws Exception {
        ...
        Playlist testPlaylist = playlistList.get(playlistList.size() - 1);
        assertThat(testPlaylist.getListId()).isEqualTo(UPDATED_LIST_ID);
