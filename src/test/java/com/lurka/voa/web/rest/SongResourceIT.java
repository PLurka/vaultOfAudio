...
public class SongResourceIT {
    ...
    public void createSong() throws Exception {
        ...
        assertThat(testSong.getSongId()).isEqualTo(DEFAULT_SONG_ID);
    ...
    @Test
    @Transactional
    public void checkSongIdIsRequired() throws Exception {
    ...
    public void updateSong() throws Exception {
        ...
        Song testSong = songList.get(songList.size() - 1);
        assertThat(testSong.getSongId()).isEqualTo(UPDATED_SONG_ID);
