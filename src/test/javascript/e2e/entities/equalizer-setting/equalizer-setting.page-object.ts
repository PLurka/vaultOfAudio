...
export class EqualizerSettingUpdatePage {
  ...
  equalizerIdInput = element(by.id('field_equalizerId'));
  ...
  async setEqualizerIdInput(equalizerId) {
    await this.equalizerIdInput.sendKeys(equalizerId);
  }

  async getEqualizerIdInput() {
    return await this.equalizerIdInput.getAttribute('value');
  }
