...
public class EqualizerSetting implements Serializable {
    ...
    @NotNull
    @Column(name = "equalizer_id", nullable = false, unique = true)
    private Integer equalizerId;
    ...
    public Integer getEqualizerId() {
        return equalizerId;
    }

    public EqualizerSetting equalizerId(Integer equalizerId) {
        this.equalizerId = equalizerId;
        return this;
    }

    public void setEqualizerId(Integer equalizerId) {
        this.equalizerId = equalizerId;
    }
